            ...
            (    
              <>
                <li className={currentTab==="myFeed" ? "is-active" : ""}>
                  <Link to="#" onClick={this.handleTab} name="myFeed">My Articles</Link>
                </li>
                <li className={currentTab==="favorites" ? "is-active" : ""}>
                  <Link to="#"  onClick={this.handleTab} name="favorites">Favorites</Link>
                </li>
              </>   
            )
          :
            (
              <>
                  ...
                  auth.isLogged() 
                    ...
                    (        
                      <li className={currentTab==="yourFeed" ? "is-active" : ""}>
                        <Link to="#"  onClick={this.handleTab} name="yourFeed">Your Feed</Link>
                      </li>
                    ) 
                    : 
                    (<></>)
                ...
                <li className={currentTab==="globalFeed" ? "is-active" : ""}>
                  <Link to="#"  onClick={this.handleTab} name="globalFeed">Global Feed</Link>
                </li>
                  
                {
                  ...
                  (
                    <li className={currentTab==="tagFeed" ? "is-active" : ""}>
                      <Link to="#"  onClick={this.handleTab} name="tagFeed"># {tag}</Link>
                    </li>
                  )
                  :
                  (<></>)
