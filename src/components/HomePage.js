...
export class HomePage extends React.Component {
  ...
  fetchArticles = (filter={}) => {
    ...
    if(!this.isYourFeed){
      ...
      const URL = `https://conduit.productionready.io/api/articles?limit=10&offset=${offset || "0"}&tag=${tag || ""}&author=${author || ""}&favorited=${favorited || ""}`;
      ...
      const URL = `https://conduit.productionready.io/api/articles/feed?limit=10&offset=${offset || "0"}`;
  ...
  render() {
    const {articles, isLoading, page, tag, articlesCount, initailTab} = this.state
        ...
        <div className="base column is-8 is-offset-2">
          <section className="main-container">
            <div className="column is-three-quarters">
              <ShowTab tag={tag} initailTab={initailTab} changeTab={this.handleTab}/>
